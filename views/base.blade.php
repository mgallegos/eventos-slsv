...
<head>
	...
	@include('decima-eventos-slsv::css')
	@include('decima-eventos-slsv::agenda-css')
	@include('decima-eventos-slsv::eventos-slsv-css')
	@include('decima-eventos-slsv::js')
	<!-- <script>
  ...
  ga('send', 'pageview');
	...
	<meta name="keywords" content="ECOMMERCE,TIENDA,SV,eventos-slsv,eventos-slsvSV,COMPRALOCAL,COMPRALOCALSV"/> -->
	<!-- for Facebook -->
...
<body id='body'>
	...
	@include('decima-eventos-slsv::top-bar')
  ...
  @include('decima-eventos-slsv::footer')
	@include('decima-eventos-slsv::terminosycondiciones')
	@include('decima-eventos-slsv::avisoconstruccion')
